# Copyright 2024 Brazilian FOSS Community 
...
#DEPEND="alsa-lib libsdl2 pulseaudio libpulse jack-audio-connection-kit" # depending on flags
RDEPEND="${DEPEND}"
...
src_configure() {
	local myfeatures=(
		$(use alsa && echo "alsa-backend")
		$(use pulseaudio && echo "pulseaudio-backend")
		$(use portaudio && echo "portaudio-backend")
		$(use sdl && "sdl-backend")
		$(use gstreamer && "gstreamer-backend")
		$(use jack && "jackaudio-backend")
		$(use rodio && "rodio-backend")
		$(use jack-on-rodio && "rodiojack-backend")
	)
