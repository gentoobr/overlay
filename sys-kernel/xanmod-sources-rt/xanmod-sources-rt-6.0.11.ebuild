...
SRC_URI="
	...
	${XANMOD_URI}/${OKV}-${_RT_VERSION}-xanmod${XANMOD_VERSION}/patch-${OKV}-${_RT_VERSION}-xanmod${XANMOD_VERSION}.xz -> 2909-xanmod.patch.xz
	${GENPATCHES_URI}"
...
src_unpack() {
	UNIPATCH_LIST="${DISTDIR}/2909-xanmod.patch.xz "
	kernel-2_src_unpack
}
